...
<body class="p4">
	...
	<div>
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="firstName" placeholder=" Enter Your First Name" value="<%=DataUtility.getStringData(dto.getFirstName())%>">
      </div>
    </div>
    ...
    <div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="lastName" placeholder="Enter Your Last Name" value="<%=DataUtility.getStringData(dto.getLastName())%>">
      </div>
    </div>
    ...
    <div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="password" class="form-control" name="password" placeholder=" Enter Your password" value="<%=DataUtility.getStringData(dto.getPassword())%>">
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="password" class="form-control" name="confirmPassword" placeholder=" Enter Your confirmPassword" value="<%=DataUtility.getStringData(dto.getConfirmPassword())%>">
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="defaultForm-email" name="emailId" placeholder=" Enter Your email Id" value="<%=DataUtility.getStringData(dto.getLogin())%>">
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="defaultForm-email" maxlength="10" name="mobileNo"placeholder="Enter Your mobile No" value="<%=DataUtility.getStringData(dto.getMobileNo())%>">
      </div>
    </div>							
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker2" name="dob" class="form-control" placeholder=" Enter Date Of Birth" readonly="readonly" value="<%=DataUtility.getDateString(dto.getDob())%>">
      </div>
    </div>	

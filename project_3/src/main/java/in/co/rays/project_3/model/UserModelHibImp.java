		...
		try {
			...
			if (dto != null) {
				...
				if (dto.getFirstName() != null && dto.getFirstName().length() > 0) {
					criteria.add(Restrictions.or(Restrictions.like("firstName", dto.getFirstName()), Restrictions.like("lastName", dto.getFirstName())));
				}


				if (dto.getLastName() != null && dto.getLastName().length() > 0) {
					criteria.add(Restrictions.like("lastName", dto.getFirstName() + "%"));
				}
